...
typedef struct//banderas logicas de las interrupciones de los puertos
{
	uint8_t flag_port_a : 1;//bitfield
...
typedef enum {GPIO_INPUT,/*!< Definition to configure a pin as output */
